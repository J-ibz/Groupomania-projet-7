  ...
  <div class="modal">
    ...
    <div class="main">
      ...
      <section class="modal-body">
        ...
        <textarea v-model="editedMessage" @input="resize($event)" type="text" />
      </section>
      <section class="modal-file">
        ...
        <img v-show="editedMessageUrl" class="publication-photo" :src="editedMessageUrl" alt="picture" />
      </section>
      <footer>
...
export default {
  ...
  components: { AddImage, Close, Modal, Loading, Trash },
  ...
  methods: {
    ...
    selectFile() {
      ...
      this.editedMessageUrl = URL.createObjectURL(this.file);
    },
    ...
    getMessageData() {
      axios
        .get("http://127.0.0.1:3000/api/messages/" + this.$route.params.id, {
          headers: { Authorization: "Bearer " + sessionStorage.getItem("token") },
        })
        .then((res) => {
          this.editedMessage = res.data.message;
          this.editedMessageUrl = res.data.messageUrl;
    ...
    updatePublication() {
      ...
      formData.append("message", this.editedMessage.toString());
      formData.append("image", this.file);

      console.log("what is this.file");
      console.log(this.file);
      console.log("what is this.editedMessage");
